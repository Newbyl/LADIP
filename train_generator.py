...
from models.sit_generator import SiT_models
from loss_generator import SILoss
...
def main(args):    
    ...
    vae = AutoencoderKL.from_pretrained(f"pretrained_models/sd-vae-ft-mse").to(device)
